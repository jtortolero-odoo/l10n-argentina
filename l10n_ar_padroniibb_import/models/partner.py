...
class res_partner(models.Model):
    ...
    def _compute_sit_iibb(self, padron_tax):
        ...
        if padron_tax.multilateral:
            ...
            local_record = self.env.ref("l10n_ar_perceptions.iibb_situation_local")
    ...
    def _update_perception_partner(self, perception):
        ...
        partner_perception_ids = partner_perception_obj.search(
            [("partner_id", "=", self.id), ("perception_id", "=", perception_id)]
        )
        ...
        for partner in self:
            ...
            if vat:
                if customer:
                    ...
                    if vat_changed:
                        old_perceps = partner.read(["perception_ids"])[0][
                            "perception_ids"
                        ]
                ...
                if supplier:
                    ...
                    if "retention_ids" in vals:
                        ...
                        real_comms = []
                    if vat_changed:
                        old_retent = partner.read(["retention_ids"])[0]["retention_ids"]
